...
const Index = () => {
  const text = "Elevate Your Brand with Expert SEO & Digital Marketing";
  const words = text.split(" "); // Split sentence into individual words
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 ">
              ...
              >
                {words.map((word, index) => (
                  <span
                    ...
                    style={{ animationDelay: `${index * 0.15}s` }} // Adjust the delay for each word
                  >
                    {word}&nbsp;
                  </span>
                ))}
            ...
            <div className="relative flex justify-center items-center lg:items-start">
              <img
                ...
                alt="Portfolio"
                className="h-[400px] lg:h-[500px] z-10 mx-auto lg:mx-0  zoom-in-animation"
              />
      ...
      <div className="pt-12 bg-[#F1E6F7]">
        <div className="bg-[#4E2FDA] text-white flex items-center justify-center min-h-[200px] md:min-h-[400px] relative overflow-hidden ">
          ...
          <div className="text-center p-6">
            ...
            <p
              className="text-white text-xs md:text-sm fade-in-up"
              style={{ lineHeight: "1.4" }}
            >
            ...
            <div className="flex flex-col items-center mt-8">
              <button className="bg-white relative overflow-hidden text-xs md:text-sm mt-6 font-medium text-[#4E2FDA] hover:text-white rounded-full pl-4 pr-2 py-2 flex items-center group transition-transform duration-300 hover:-translate-y-1 fade-in-up w-fit ">
