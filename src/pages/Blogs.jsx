    ...
    <div>
       <div className="relative text-center max-w-screen-md py-20  mx-auto px-4 sm:px-8">
        ...
        <div className="md:px-8 lg:px-40 md: mx-auto grid gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 mt-4">
          {/* Card 1 */}
          <div className="rounded overflow-hidden flex flex-col fade-in-left">
          ...
          {/* Card 2 */}
          <div className=" rounded  overflow-hidden flex flex-col fade-in-up">
            <div className="relative overflow-hidden group">
              <img
          ...
          {/* Card 3 */}
          <div className="rounded shadow overflow-hidden flex flex-col fade-in-right">
            <div className="relative overflow-hidden group">
              <img
