...
const Service3 = () => {
  ...
  return (
    <div className="overflow-hidden">
      ...
      <div className="bg-white pt-8 px-6 md:px-16 lg:px-40">
        <div className="grid grid-cols-1 md:grid-cols-2 space-y-4 lg:space-x-6 mx-auto">
          ...
          {/* Right  Container */}
          <div className="right-content  lg:text-left md:px-4 flex flex-col items-center justify-center ">
            <div className="">
              ...
              >
                ...
                ability to deliver personalized content directly to your
                customers' inboxes, email marketing is essential for building
          ...
          <div className="right-content text-center lg:text-left md:px-4 flex flex-col items-center pt-12 md:pt-32 ">
            <div className="">
              ...
              <p
                ...
                className="mt-3 text-gray-500 text-xs md:text-sm transition-all "
              >
                We develop customized email marketing strategies that align with
                your business goals and target audience. We segment your email
                list to ensure that your messages are relevant personalized for
                different audience groups. <br />
                We create a comprehensive content calendar to schedule and plan
          ...
          <div className="left-content text-center lg:text-left md:px-4 flex flex-col items-center pt-12 md:pt-36 ">
            <div className="">
              ...
              <p
                ...
                className="mt-3 text-gray-500 text-xs md:text-sm transition-all "
              >
                We design and develop responsive email templates that look great
                on all devices, ensuring seamless experience. <br />
          ...
          <div className="right-content text-center lg:text-left md:px-4 flex flex-col items-center pt-12 md:pt-32 ">
            <div className="">
              ...
              <p
                ...
                className="mt-3 text-gray-500 text-xs md:text-sm transition-all "
              >
                We craft compelling email copy that resonates with your audience
                and drives action. We include relevant images, videos, and other
                media to enhance your emails and keep them visually appealing.
                <br /> We create informative and engaging content that adds
                value to your subscribers and encourages them to stay connected.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="pt-6 custom-analyze bg-white ">
